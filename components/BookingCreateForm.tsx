...
export default function BookingCreateForm({ car }: { car: Car }) {
  ...
  return (
    <form className="card" onSubmit={onSubmit}>
      ...
      <p className="small muted">Backend validation will reject invalid duration, overlapping bookings, or more than 3 bookings for normal users.</p>
